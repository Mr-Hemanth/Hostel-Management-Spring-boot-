        ...
        <div className="p-6 max-w-2xl mx-auto">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
                <div className="flex flex-col items-center text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">{studentInfo?.user?.name || 'Student'}</h2>
                    <p className="text-indigo-600 font-medium">Hostel Resident</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div className="flex-1">
                            <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Current Room</p>
                            <p className="text-gray-900 font-medium">
                                {studentInfo?.room ? `Room ${studentInfo.room.roomNumber}` : 'Not Assigned'}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div className="flex-1">
                            <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Student ID</p>
                            <p className="text-gray-900 font-medium">#{studentInfo?.id || 'N/A'}</p>
                        </div>
                    </div>
                </div>
